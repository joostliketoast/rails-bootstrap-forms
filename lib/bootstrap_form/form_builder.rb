  ...
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    def generate_help_tooltip(options)
      if options && options[:icon].present?
        ...
        content_tag(:a, '', title: title, role: 'button', class: 'rails-bootstrap-forms-tooltip-button',tabindex: 0, data: { toggle: toggle, content: tooltip_content, placement: placement, container: container, trigger: trigger, html: html }) do
